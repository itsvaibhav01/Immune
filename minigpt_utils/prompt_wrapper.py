...
class Prompt:
    ...
    def __init__(self, model, text_prompts=None, img_prompts=None, device='cpu', max_new_tokens=300, max_length=2000):
    ...
    def add_token_to_prompt(self, token):
        emb = self.model.llama_model.model.embed_tokens(token)
        self.context_embs = [torch.cat((self.context_embs[0], emb), dim=1)]
